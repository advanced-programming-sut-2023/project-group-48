...
public enum BuildingType {
    ...
    private static final HashMap<String, ImagePattern> imagePatterns = new HashMap<>() {{
        ...
        put("Good Things", new ImagePattern(new Image(Objects.requireNonNull(getClass().getResource("/buildings/Normal/Good Stuff/Good Thing.png")).toExternalForm())));
        put("Bad Things", new ImagePattern(new Image(Objects.requireNonNull(getClass().getResource("/buildings/Normal/Bad Stuff/Bad Thing.gif")).toExternalForm())));
        ...
        put("Killing Pit", new ImagePattern(new Image(Objects.requireNonNull(getClass().getResource("/buildings/Trap/Killing Pit Empty.png")).toExternalForm())));
